...
const Event = ({ start, end, location, name, descripton, color }) => {
  return (
    <div className="bg-ewb-blue-100 flex w-full font-bold">
      <div
        className={`text-4xl text-white text-center w-1/2 aspect-square flex flex-col items-center justify-center ${COLORS[color].bg}`}
      >
      ...
      <div className="p-3 w-5/6 text-ewb-black ">
        ...
        <div className="text-sm font-normal">{descripton}</div>
      </div>
    </div>
  );
};
